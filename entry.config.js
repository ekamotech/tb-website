...
module.exports = {
  ...
  'page/group-member': path.resolve(__dirname, 'src/main/resources/scss/page/group-member.scss'),
  ...
  'page/event-attendee': path.resolve(__dirname, 'src/main/resources/scss/page/event-attendee.scss'),
